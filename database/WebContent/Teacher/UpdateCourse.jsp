				...
				<div>
					...
					<form action="UpdateCourseServlet" method="post"
						...
						<table class="table" align="center">
							<input class="form-control" type="hidden" name="CourseNum"
							...
							<tr>
								<td>课程学分</td>
								<td><input type="text" name="CourseCredit"
									value="<%=course.getCourseCredit()%>"
									onclick=javascript:this.value=''></td>
							</tr>
							<tr>
								<td>课时</td>
								<td><input type="text" name="CourseTime"
									value="<%=course.getCourseTime()%>"
									onclick=javascript:this.value=''></td>
							</tr>
							<tr>
								<td>授课老师</td>
								<td><input type="text" name="TeacherName"
									value="<%=course.getTeacherName()%>"></td>
							</tr>
							<tr>
